...
const ASSETS_TO_CACHE = [
    ...
    `${BASE_PATH}js/components/BoundaryEditor.js`,
    `${BASE_PATH}js/components/Detector.js`,
    `${BASE_PATH}js/utils/logger.js`,
    `${BASE_PATH}js/utils/geometry.js`,
    `${BASE_PATH}js/utils/storage.js`,
